...
template <class Type> class _vertex2{
	public:
		...
		_vertex2 &operator()(Type x1, Type y1);
		...
		inline Type &operator[](int Position){
			return *(&x+Position);
		};
		void show_values();
};
...
template <class Type> class _vertex3{
	public:
		...
		_vertex3 &operator()(Type x1, Type y1, Type z1);
...
template <class Type> class _vertex4{
	public:
		...
		_vertex4 &operator()(Type x1, Type y1, Type z1, Type w1 = 0);
...
template <class Type> class _plane:public _vertex4<Type>{
	public:
		...
		int compute_coefficients(_vertex3<Type> Vertex1, _vertex3<Type> Vertex2, _vertex3<Type> Vertex3);
...
template <class Type> class _bounding_box3{
	public:
		...
		bool Computed;
		_bounding_box3(Type XMin1 = (Type) MAX_FLOAT_VALUE, Type YMin1 = (Type) MAX_FLOAT_VALUE, Type ZMin1 = (Type) MAX_FLOAT_VALUE, 
			Type XMax1 =- (Type) MAX_FLOAT_VALUE, Type YMax1 =- (Type) MAX_FLOAT_VALUE, Type ZMax1 =- (Type) MAX_FLOAT_VALUE);
...
template <class Type> _vertex2<Type> &_vertex2<Type>::operator()(Type x1,Type y1){
	x = x1;
	y = y1;
	return(*this);
}

template <class Type> _vertex2<Type> &_vertex2<Type>::operator()(const _vertex2<Type> &Vertex1){
	x = Vertex1.x;
	y = Vertex1.y;
	return(*this);
}

template <class Type> _vertex2<Type> &_vertex2<Type>::operator()(const _vertex3<Type> &Vertex1){
	x	=	Vertex1.x;
	y	=	Vertex1.y;
	return(*this);
}

template <class Type> _vertex2<Type> &_vertex2<Type>::operator()(const _vertex4<Type> &Vertex1){
	x = Vertex1.x;
	y = Vertex1.y;
	return(*this);
}

template <class Type> _vertex2<Type> &_vertex2<Type>::operator()(Type *Vertices1){
	x = Vertices1[0];
	y = Vertices1[1];
	return(*this);
}
...
template <class Type> bool _vertex2<Type>::operator==(const _vertex2<Type> &Vertex1){
...
template <class Type> _vertex3<Type> &_vertex3<Type>::operator()(Type x1,Type y1,Type z1){
	x = x1;
	y = y1;
	z = z1;
	return(*this);
...
template <class Type> _vertex3<Type> &_vertex3<Type>::operator()(const _vertex2<Type> &Vertex1){
	x = Vertex1.x;
	y = Vertex1.y;
	return(*this);
}

template <class Type> _vertex3<Type> &_vertex3<Type>::operator()(const _vertex3<Type> &Vertex1){
	x = Vertex1.x;
	y = Vertex1.y;
	z = Vertex1.z;
	return(*this);
